...
brew install node rlwrap curl wget htop unrar watch vim imagemagick rsync gifsicle asciinema ffmpeg pgrep axel mtr go app-engine-go-64 tmate tree jsonpp jq yq ctags Caskroom/cask/keycastr moreutils httpie yq awscli
